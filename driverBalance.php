...
if($con)
{		
$query="select dWallet from driver where mobileNumber=$mobileNumber";
...
echo "<p style='margin-top:0%;font-size:50;font-family:serif;color:red;text-align:center'><br><br>Your current balance is Rs ".$dWallet."</p>";
echo"</div>";
?>